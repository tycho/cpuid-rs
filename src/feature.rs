...
static FEATURES_8000_000A_EDX: [FeatureSpec; 40] = [
    ...
    FeatureSpec { bit: 5,  vendor_mask: VendorMask::AMD,      shortname: "", name: "VMCB clean bits", },
    FeatureSpec { bit: 6,  vendor_mask: VendorMask::AMD,      shortname: "", name: "Flush by ASID", },
    FeatureSpec { bit: 7,  vendor_mask: VendorMask::AMD,      shortname: "", name: "Decode assists", },
    FeatureSpec { bit: 8,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 9,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
