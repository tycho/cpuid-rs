...
static FEATURES_8000_000A_EDX: [FeatureSpec; 40] = [
    ...
    FeatureSpec { bit: 8,  vendor_mask: VendorMask::AMD,      shortname: "", name: "Decode assists", },
    FeatureSpec { bit: 9,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 10, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 11, vendor_mask: VendorMask::AMD,      shortname: "", name: "Pause intercept filter", },
    FeatureSpec { bit: 12, vendor_mask: VendorMask::AMD,      shortname: "", name: "Encrypted µcode patch", },
    FeatureSpec { bit: 13, vendor_mask: VendorMask::AMD,      shortname: "", name: "Pause filter threshold", },
    FeatureSpec { bit: 14, vendor_mask: VendorMask::AMD,      shortname: "AVIC", name: "AMD virtual interrupt controller", },
    FeatureSpec { bit: 15, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 16, vendor_mask: VendorMask::AMD,      shortname: "", name: "Virtualized VMLOAD/VMSAVE", },
    FeatureSpec { bit: 17, vendor_mask: VendorMask::AMD,      shortname: "", name: "Virtualized GIF", },
    FeatureSpec { bit: 18, vendor_mask: VendorMask::AMD,      shortname: "GMET", name: "Guest mode execution trap", },
    FeatureSpec { bit: 19, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 20, vendor_mask: VendorMask::AMD,      shortname: "", name: "SVM supervisor shadow stack restrictions", },
    FeatureSpec { bit: 21, vendor_mask: VendorMask::AMD,      shortname: "GuesSpecCtl", name: "SPEC_TRL virtualization", },
    FeatureSpec { bit: 22, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 23, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 24, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 25, vendor_mask: VendorMask::AMD,      shortname: "", name: "INVLPGB/TLBSYNC hypervisor enable", },
    FeatureSpec { bit: 26, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 27, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 28, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 29, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
