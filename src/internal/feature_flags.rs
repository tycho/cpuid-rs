...
pub static FEATURES_0000_0007_0_EBX: [FeatureSpec; 33] = [
    ...
    FeatureSpec { bit: 1,  vendor_mask: VendorMask::INTELAMD, shortname: "TSC_ADJUST", name: "IA32_TSC_ADJUST MSR is supported", },
    ...
    FeatureSpec { bit: 16, vendor_mask: VendorMask::INTELAMD, shortname: "AVX512F", name: "AVX512 foundation", },
    FeatureSpec { bit: 17, vendor_mask: VendorMask::INTELAMD, shortname: "AVX512DQ", name: "AVX512 double/quadword instructions", },
    ...
    FeatureSpec { bit: 21, vendor_mask: VendorMask::INTELAMD, shortname: "AVX512IFMA", name: "AVX512 integer FMA instructions", },
    ...
    FeatureSpec { bit: 28, vendor_mask: VendorMask::INTELAMD, shortname: "AVX512CD", name: "AVX512 conflict detection instructions", },
    FeatureSpec { bit: 29, vendor_mask: VendorMask::INTELAMD, shortname: "SHA", name: "SHA-1/SHA-256 instructions", },
    FeatureSpec { bit: 30, vendor_mask: VendorMask::INTELAMD, shortname: "AVX512BW", name: "AVX512 byte/word instructions", },
    FeatureSpec { bit: 31, vendor_mask: VendorMask::INTELAMD, shortname: "AVX512VL", name: "AVX512 vector length instructions", },
];
...
pub static FEATURES_0000_0007_0_EDX: [FeatureSpec; 32] = [
    ...
    FeatureSpec { bit: 6,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 7,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 8,  vendor_mask: VendorMask::INTELAMD, shortname: "AVX512_VP2INTERSECT", name: "AVX512 Vector Intersection instructions", },
    FeatureSpec { bit: 9,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
...
pub static FEATURES_0000_0007_1_EAX: [FeatureSpec; 32] = [
    ...
    FeatureSpec { bit: 2,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 3,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 4,  vendor_mask: VendorMask::INTELAMD, shortname: "AVX_VNNI", name: "AVX Vector Neural Network Instructions", },
    FeatureSpec { bit: 5,  vendor_mask: VendorMask::INTELAMD, shortname: "AVX512_BF16", name: "AVX512 Vector Neural Network BFLOAT16", },
    FeatureSpec { bit: 6,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 7,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 8,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 9,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
...
pub static FEATURES_8000_000A_EDX: [FeatureSpec; 32] = [
    ...
    FeatureSpec { bit: 8,  vendor_mask: VendorMask::AMD,      shortname: "PerfCtrVirt", name: "Performance Monitor Counter virtualization", },
    FeatureSpec { bit: 9,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    ...
    FeatureSpec { bit: 18, vendor_mask: VendorMask::AMD,      shortname: "X2AVIC", name: "Virtualized X2APIC", },
    FeatureSpec { bit: 19, vendor_mask: VendorMask::AMD,      shortname: "SSSCheck", name: "SVM supervisor shadow stack restrictions", },
    FeatureSpec { bit: 20, vendor_mask: VendorMask::AMD,      shortname: "GuestSpecCtl", name: "SPEC_CTRL virtualization", },
    FeatureSpec { bit: 21, vendor_mask: VendorMask::AMD,      shortname: "AllowNonWriteAbleGPT", name: "Support Non-Writeable Guest Pages for NPT", },
    FeatureSpec { bit: 22, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    ...
    FeatureSpec { bit: 25, vendor_mask: VendorMask::AMD,      shortname: "NmiVirt", name: "Guest NMI virtualization", },
    FeatureSpec { bit: 26, vendor_mask: VendorMask::AMD,      shortname: "IbsVirt", name: "IBS virtualization", },
    FeatureSpec { bit: 27, vendor_mask: VendorMask::AMD,      shortname: "ExtLvtOffsetFaultChg", name: "Read-only extended LVT offsets", },
    FeatureSpec { bit: 28, vendor_mask: VendorMask::AMD,      shortname: "VmcbAddrChkChg", name: "VMCB address check change", },
    FeatureSpec { bit: 29, vendor_mask: VendorMask::AMD,      shortname: "GuestBusLockThreshold", name: "Intercept guest after N bus locks", },
    FeatureSpec { bit: 30, vendor_mask: VendorMask::AMD,      shortname: "IdleHltIntercept", name: "HLT idle interception", },
    FeatureSpec { bit: 31, vendor_mask: VendorMask::AMD,      shortname: "", name: "Enhanced shutdown intercetpt", },
];
...
pub static FEATURES_8000_001A_EAX: [FeatureSpec; 32] = [
    ...
    FeatureSpec { bit: 3,  vendor_mask: VendorMask::AMD,      shortname: "FP512", name: "512-bit AVX full-width pipelines", },
    FeatureSpec { bit: 4,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 5,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 6,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 7,  vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
...
pub static FEATURES_8000_001B_EAX: [FeatureSpec; 32] = [
    ...
    FeatureSpec { bit: 11, vendor_mask: VendorMask::AMD,      shortname: "Zen4IbsExtensions", name: "L3 Miss Filtering for IBS", },
    FeatureSpec { bit: 12, vendor_mask: VendorMask::AMD,      shortname: "IbsLoadLatencyFiltering", name: "Filter IBS execution samples based on load latency", },
    FeatureSpec { bit: 13, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 14, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 15, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 16, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 17, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 18, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 19, vendor_mask: VendorMask::AMD,      shortname: "IbsUpdtdDtlbStats", name: "Simplified DTLB page size and miss reporting", },
    FeatureSpec { bit: 20, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 21, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 22, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
    FeatureSpec { bit: 23, vendor_mask: VendorMask::UNKNOWN,  shortname: "", name: "", },
